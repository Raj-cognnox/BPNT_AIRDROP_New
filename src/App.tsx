...
class App extends React.Component<any, any> {
  ...
  public onConnect = async () => {
    ...
    let referrer = window.location.href.split("referrer=")[1]
      ...
      <div>
        ...
        {fetching ? (
          ...
          <Switch>
            <Route exact path="/">
              <div>
                <Dashboard web3={web3} address={address} referrer={this.state.referrer} chainId={this.state.chainId} updateState={this.updateState} />
              </div>
            </Route>
        </Switch>) : (
          <SLanding center>
            ...
            <input placeholder="Enter your Referrer here" onChange={(event) => this.setReferrer(event)}  className="text-white w-75 py-2 form-control" id="referrer" />
             <p></p>
